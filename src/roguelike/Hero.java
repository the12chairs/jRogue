...
public class Hero extends AbstractCreature implements CreatureController{
	...
	public static void main(String[] args) {
		...
		you.initRaceBonuses();
		Quest test = new Quest("./quests/test.json");
		System.out.println(you.mass.getPair());
		System.out.println("Уровень: " + you.getLevel());
		System.out.println("За квест получит: " + test.getExp());
		you.takeQuest(test);
		for(Quest q : you.questJournal){
			System.out.println(q.getTitle() + " " + q.getStatus());
		}
		you.makeQuest(test);
		System.out.println("Опыт: " + you.exp.getPair());
		System.out.println("Статус квеста: " + test.isSuccess());
		you.doLevelUp();
		System.out.println("Уровень: " + you.getLevel());
		System.out.println("Опыт: " + you.exp.getPair());
		System.out.println("Очки навыков: " + you.getStatPoints());
		System.out.println();
		for(Quest q : you.questJournal){
			System.out.println(q.getTitle() + " " + q.getStatus());
		}
